...
u.subscribe(function (t) {
  s.defaults.auth = { username: t.secretKey, password: "" };
});
var l = {
    amount: 0,
          ...
          function (t) {
            for (;;)
              switch ((t.prev = t.next)) {
                case 0:
                  return (
                    (u = e.statementDescriptor),
                    (f = e.metadata),
                    (h = {
                      attributes: {
                        amount: void 0 === (r = e.amount) ? l.amount : r,
                        payment_method_allowed:
                          void 0 === (o = e.paymentMethodAllowed)
                            ? l.paymentMethodAllowed
                            : o,
                        payment_method_options: {
                          card: {
                            request_three_d_secure:
                              void 0 === (i = e.request3DS) ? l.request3DS : i,
                          },
                        },
                        currency: void 0 === (n = e.currency) ? l.currency : n,
                      },
                    }),
                    (a = e.description) && (h.attributes.description = a),
                    u && (h.attributes.statement_descriptor = u),
                    f && (h.attributes.metadata = f),
                    (t.prev = 5),
                    (t.next = 8),
                    s.post("/payment_intents", { data: h })
                  );
                case 8:
                ...
                case 12:
                  return (
                    (t.prev = 12),
                    (t.t0 = t.catch(5)),
                    t.abrupt("return", t.t0.response.data)
                  );
                case 16:
                case "end":
                  return t.stop();
...
exports.default = function (t) {
  return (
    u.setState(function (e) {
      return i({}, e, { secretKey: t });
    }),
    { retrievePaymentIntent: h, createPaymentIntent: f }
  );
};
//# sourceMappingURL=paymongo-client.cjs.production.min.js.map
